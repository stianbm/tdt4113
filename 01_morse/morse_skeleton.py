...
# up letters and digits in this dictionary.
    ...
    def __init__(self,sport=True):
        if sport:
            self.serial_port = arduino_connect.pc_connect()#arduino_connect.basic_connect()
        self.reset()
    ...
    def update_current_symbol(self, sig):
        self.current_symbol += str(sig - 1)
        print("Code: " + self.current_symbol)
    ...
    def update_current_message(self):
        ...
        print("message: " + self.current_message)
